package anifire.skins
{
	...
	public class ColorInputPanelHueSliderSkin extends SparkSkin implements IStateClient2
	{
		...
		public function ColorInputPanelHueSliderSkin()
		{
			super();
			mx_internal::_document = this;
			this.minWidth = 11;
			this.mxmlContent = [this._ColorInputPanelHueSliderSkin_Button1_i(),this._ColorInputPanelHueSliderSkin_Button2_i()];
		...
		private function _ColorInputPanelHueSliderSkin_Button1_i() : Button
		{
			...
			_loc1_.setStyle("skinClass",ColorInputPanelHueSliderTrackSkin);
			_loc1_.id = "track";
			if(!_loc1_.document)
			{
		...
		private function _ColorInputPanelHueSliderSkin_Button2_i() : Button
		{
			var _loc1_:Button = new Button();
			_loc1_.width = 25;
			_loc1_.height = 25;
			_loc1_.tabEnabled = false;
			_loc1_.setStyle("skinClass",ColorInputPanelHueSliderThumbSkin);
			_loc1_.id = "thumb";
			if(!_loc1_.document)
			{
				_loc1_.document = this;
