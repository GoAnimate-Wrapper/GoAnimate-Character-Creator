package anifire.creator.skins
{
	...
	public class DefaultTextInputSkin extends SparkSkin implements IStateClient2
	{
		...
		public var _DefaultTextInputSkin_HGroup1:HGroup;
		...
		public function DefaultTextInputSkin()
		{
			super();
			mx_internal::_document = this;
			this.blendMode = "normal";
			this.minHeight = 32;
			this.mxmlContent = [this._DefaultTextInputSkin_Rect1_i(),this._DefaultTextInputSkin_Rect2_i(),this._DefaultTextInputSkin_Rect3_i(),this._DefaultTextInputSkin_HGroup1_i()];
			this.currentState = "normal";
			var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._DefaultTextInputSkin_Label1_i);
			states = [new State({
					"name":"normal",
					"overrides":[]
					}),new State({
						...
						"overrides":[new SetProperty().initializeFromObject({
							...
							"overrides":[new AddItems().initializeFromObject({
									...
									"position":"after",
									"relativeTo":["_DefaultTextInputSkin_HGroup1"]
									})]
							}),new State({
		...
		private function _DefaultTextInputSkin_Rect1_i() : Rect
		{
			...
			_loc1_.bottom = 0;
			_loc1_.radiusX = 3;
			_loc1_.stroke = this._DefaultTextInputSkin_SolidColorStroke1_i();
		...
		private function _DefaultTextInputSkin_SolidColorStroke1_i() : SolidColorStroke
		{
		...
		private function _DefaultTextInputSkin_Rect2_i() : Rect
		{
			var _loc1_:Rect = new Rect();
			_loc1_.left = 1;
			_loc1_.right = 1;
			...
			_loc1_.bottom = 1;
			_loc1_.radiusX = 2;
			_loc1_.fill = this._DefaultTextInputSkin_SolidColor1_i();
		...
		private function _DefaultTextInputSkin_SolidColor1_i() : SolidColor
		{
		...
		private function _DefaultTextInputSkin_Rect3_i() : Rect
		{
			var _loc1_:Rect = new Rect();
			_loc1_.left = 1;
			_loc1_.top = 1;
			...
			_loc1_.height = 1;
			_loc1_.radiusX = 2;
			_loc1_.fill = this._DefaultTextInputSkin_SolidColor2_c();
		...
		private function _DefaultTextInputSkin_SolidColor2_c() : SolidColor
		{
			var _loc1_:SolidColor = new SolidColor();
			_loc1_.color = 0;
			_loc1_.alpha = 0.12;
		...
		private function _DefaultTextInputSkin_HGroup1_i() : HGroup
		{
			...
			_loc1_.mxmlContent = [this._DefaultTextInputSkin_RichEditableText1_i()];
			_loc1_.id = "_DefaultTextInputSkin_HGroup1";
			if(!_loc1_.document)
			{
				_loc1_.document = this;
			}
			this._DefaultTextInputSkin_HGroup1 = _loc1_;
			BindingManager.executeBindings(this,"_DefaultTextInputSkin_HGroup1",this._DefaultTextInputSkin_HGroup1);
			return _loc1_;
		}

		private function _DefaultTextInputSkin_RichEditableText1_i() : RichEditableText
		{
		...
		private function _DefaultTextInputSkin_Label1_i() : Label
		{
