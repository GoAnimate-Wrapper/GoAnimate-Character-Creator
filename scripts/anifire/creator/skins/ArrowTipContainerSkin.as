package anifire.creator.skins
{
   ...
   public class ArrowTipContainerSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      private var _1656758885_ArrowTipContainerSkin_Path2:Path;
      
      private var _1211337228_ArrowTipContainerSkin_SetProperty1:SetProperty;
      
      private var _1211337229_ArrowTipContainerSkin_SetProperty2:SetProperty;
      ...
      public function ArrowTipContainerSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_creator_skins_ArrowTipContainerSkinWatcherSetupUtil");
         ...
         states = [new State({
            ...
            "overrides":[new SetProperty().initializeFromObject({
               ...
               "name":"bottom",
               "value":0
            }),this._ArrowTipContainerSkin_SetProperty1 = SetProperty(new SetProperty().initializeFromObject({
               "target":"chromeGroup",
               "name":"left",
               "value":undefined
            })),new SetProperty().initializeFromObject({
               ...
               "target":"_ArrowTipContainerSkin_Path2",
               "name":"data",
            ...
            "overrides":[new SetProperty().initializeFromObject({
               ...
               "name":"top",
               "value":0
            }),this._ArrowTipContainerSkin_SetProperty2 = SetProperty(new SetProperty().initializeFromObject({
               "target":"chromeGroup",
               "name":"left",
               "value":undefined
            })),new SetProperty().initializeFromObject({
         ...
         BindingManager.executeBindings(this,"_ArrowTipContainerSkin_SetProperty1",this._ArrowTipContainerSkin_SetProperty1);
         BindingManager.executeBindings(this,"_ArrowTipContainerSkin_SetProperty2",this._ArrowTipContainerSkin_SetProperty2);
         var i:uint = 0;
      ...
      private function _ArrowTipContainerSkin_Group3_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._ArrowTipContainerSkin_Path1_i(),this._ArrowTipContainerSkin_Path2_i()];
      ...
      private function _ArrowTipContainerSkin_Path2_i() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.left = 0;
         _loc1_.right = 0;
         ...
         this._ArrowTipContainerSkin_Path2 = _loc1_;
         BindingManager.executeBindings(this,"_ArrowTipContainerSkin_Path2",this._ArrowTipContainerSkin_Path2);
         return _loc1_;
      }
      ...
      private function _ArrowTipContainerSkin_bindingsSetup() : Array
      {
         ...
         },null,"_ArrowTipContainerSkin_SetProperty1.value");
         result[2] = new Binding(this,function():*
         {
            return hostComponent.offset;
         },null,"_ArrowTipContainerSkin_SetProperty2.value");
         return result;
      }
      ...
      [Bindable(event="propertyChange")]
      public function get _ArrowTipContainerSkin_Path2() : Path
      {
         return this._1656758885_ArrowTipContainerSkin_Path2;
      }
      
      public function set _ArrowTipContainerSkin_Path2(param1:Path) : void
      {
         var _loc2_:Object = this._1656758885_ArrowTipContainerSkin_Path2;
         if(_loc2_ !== param1)
         {
            this._1656758885_ArrowTipContainerSkin_Path2 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ArrowTipContainerSkin_Path2",_loc2_,param1));
            }
         }
      }
      
      [Bindable(event="propertyChange")]
      public function get _ArrowTipContainerSkin_SetProperty1() : SetProperty
      {
         return this._1211337228_ArrowTipContainerSkin_SetProperty1;
      }
      
      public function set _ArrowTipContainerSkin_SetProperty1(param1:SetProperty) : void
      {
         var _loc2_:Object = this._1211337228_ArrowTipContainerSkin_SetProperty1;
         if(_loc2_ !== param1)
         {
            this._1211337228_ArrowTipContainerSkin_SetProperty1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ArrowTipContainerSkin_SetProperty1",_loc2_,param1));
            }
         }
      }
      
      [Bindable(event="propertyChange")]
      public function get _ArrowTipContainerSkin_SetProperty2() : SetProperty
      {
         return this._1211337229_ArrowTipContainerSkin_SetProperty2;
      }
      
      public function set _ArrowTipContainerSkin_SetProperty2(param1:SetProperty) : void
      {
         var _loc2_:Object = this._1211337229_ArrowTipContainerSkin_SetProperty2;
         if(_loc2_ !== param1)
         {
            this._1211337229_ArrowTipContainerSkin_SetProperty2 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ArrowTipContainerSkin_SetProperty2",_loc2_,param1));
            }
         }
      }
