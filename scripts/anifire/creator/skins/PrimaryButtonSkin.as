package anifire.creator.skins
{
   ...
   public class PrimaryButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _1233170516_PrimaryButtonSkin_SolidColor1:SolidColor;
      ...
      public function PrimaryButtonSkin()
      {
         ...
         states = [new State({
            ...
            "overrides":[new SetProperty().initializeFromObject({
               "target":"_PrimaryButtonSkin_SolidColor1",
               "name":"color",
               "value":14509346
            })]
         }),new State({
      ...
      private function _PrimaryButtonSkin_SolidColor1_i() : SolidColor
      {
         ...
         this._PrimaryButtonSkin_SolidColor1 = _loc1_;
         BindingManager.executeBindings(this,"_PrimaryButtonSkin_SolidColor1",this._PrimaryButtonSkin_SolidColor1);
         return _loc1_;
      }
      ...
      public function get _PrimaryButtonSkin_SolidColor1() : SolidColor
      {
         return this._1233170516_PrimaryButtonSkin_SolidColor1;
      }
      
      public function set _PrimaryButtonSkin_SolidColor1(param1:SolidColor) : void
      {
         var _loc2_:Object = this._1233170516_PrimaryButtonSkin_SolidColor1;
         if(_loc2_ !== param1)
         {
            this._1233170516_PrimaryButtonSkin_SolidColor1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_PrimaryButtonSkin_SolidColor1",_loc2_,param1));
            }
         }
      }
