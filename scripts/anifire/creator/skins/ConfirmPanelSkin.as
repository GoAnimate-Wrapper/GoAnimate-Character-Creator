package anifire.creator.skins
{
   ...
   public class ConfirmPanelSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ConfirmPanelSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_creator_skins_ConfirmPanelSkinWatcherSetupUtil");
         ...
         this.minWidth = 300;
         this.minHeight = 200;
         this.mxmlContent = [this._ConfirmPanelSkin_RectangularDropShadow1_i(),this._ConfirmPanelSkin_Group1_c()];
      ...
      private function _ConfirmPanelSkin_RectangularDropShadow1_i() : RectangularDropShadow
      {
      ...
      private function _ConfirmPanelSkin_Group1_c() : Group
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.mxmlContent = [this._ConfirmPanelSkin_Rect1_i(),this._ConfirmPanelSkin_Group2_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ConfirmPanelSkin_Group4_i() : Group
      {
         ...
         _loc1_.minWidth = 0;
         _loc1_.minHeight = 0;
         _loc1_.mxmlContent = [this._ConfirmPanelSkin_Line1_c(),this._ConfirmPanelSkin_Group5_i()];
      ...
      private function _ConfirmPanelSkin_Line1_c() : Line
      {
         var _loc1_:Line = new Line();
         _loc1_.top = 0;
         _loc1_.left = 0;
         _loc1_.right = 0;
         _loc1_.stroke = this._ConfirmPanelSkin_SolidColorStroke1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _ConfirmPanelSkin_SolidColorStroke1_c() : SolidColorStroke
      {
