package anifire.creator.skins
{
	...
	public class DefaultDropDownListButtonSkin extends SparkSkin implements IStateClient2
	{
		...
		private function _DefaultDropDownListButtonSkin_Line1_c() : Line
		{
			...
			_loc1_.top = 8;
			_loc1_.bottom = 8;
			_loc1_.stroke = this._DefaultDropDownListButtonSkin_SolidColorStroke2_c();
			_loc1_.initialized(this,null);
			return _loc1_;
		}

		private function _DefaultDropDownListButtonSkin_SolidColorStroke2_c() : SolidColorStroke
		{
			var _loc1_:SolidColorStroke = new SolidColorStroke();
			_loc1_.color = 13289940;
			return _loc1_;
		...
		private function _DefaultDropDownListButtonSkin_Path1_i() : Path
		{
			...
			_loc1_.stroke = this._DefaultDropDownListButtonSkin_SolidColorStroke3_c();
		...
		private function _DefaultDropDownListButtonSkin_SolidColorStroke3_c() : SolidColorStroke
		{
			var _loc1_:SolidColorStroke = new SolidColorStroke();
