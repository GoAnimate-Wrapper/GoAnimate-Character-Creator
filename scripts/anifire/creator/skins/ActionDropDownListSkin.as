package anifire.creator.skins
{
   ...
   public class ActionDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ActionDropDownListSkin()
      {
         ...
         bindings = this._ActionDropDownListSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_creator_skins_ActionDropDownListSkinWatcherSetupUtil");
         ...
         {
            return ActionDropDownListSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.width = 110;
         this.minHeight = 32;
         this.mxmlContent = [this._ActionDropDownListSkin_Button1_i(),this._ActionDropDownListSkin_HGroup1_c()];
         this.currentState = "normal";
         var _ActionDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._ActionDropDownListSkin_PopUpAnchor1_i,this._ActionDropDownListSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "itemsFactory":_ActionDropDownListSkin_PopUpAnchor1_factory,
               "destination":null,
      ...
      {
         ActionDropDownListSkin._watcherSetupUtil = param1;
      }
      ...
      private function _ActionDropDownListSkin_PopUpAnchor1_i() : PopUpAnchor
      {
         ...
         _loc1_.popUp = this._ActionDropDownListSkin_Group1_i();
         _loc1_.id = "popUp";
         if(!_loc1_.document)
         {
      ...
      private function _ActionDropDownListSkin_PopUpAnchor1_r() : void
      {
      }
      
      private function _ActionDropDownListSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.minHeight = 200;
         _loc1_.maxHeight = 400;
         _loc1_.mxmlContent = [this._ActionDropDownListSkin_RectangularDropShadow1_i(),this._ActionDropDownListSkin_Rect1_i(),this._ActionDropDownListSkin_Scroller1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ActionDropDownListSkin_RectangularDropShadow1_i() : RectangularDropShadow
      {
      ...
      private function _ActionDropDownListSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 3;
         _loc1_.stroke = this._ActionDropDownListSkin_SolidColorStroke1_i();
         _loc1_.fill = this._ActionDropDownListSkin_SolidColor1_i();
      ...
      private function _ActionDropDownListSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _ActionDropDownListSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _ActionDropDownListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._ActionDropDownListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ActionDropDownListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._ActionDropDownListSkin_ClassFactory1_c();
         _loc1_.layout = this._ActionDropDownListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ActionDropDownListSkin_ClassFactory1_c() : ClassFactory
      {
      ...
      private function _ActionDropDownListSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _ActionDropDownListSkin_Button1_i() : Button
      {
      ...
      private function _ActionDropDownListSkin_HGroup1_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._ActionDropDownListSkin_BitmapImage1_i(),this._ActionDropDownListSkin_Label1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ActionDropDownListSkin_BitmapImage1_i() : BitmapImage
      {
      ...
      private function _ActionDropDownListSkin_Label1_i() : Label
      {
      ...
      private function _ActionDropDownListSkin_bindingsSetup() : Array
      {
         var result:Array = [];
