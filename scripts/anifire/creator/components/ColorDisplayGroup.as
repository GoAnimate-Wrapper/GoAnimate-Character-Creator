package anifire.creator.components
{
   ...
   public class ColorDisplayGroup extends Group implements IBindingClient
   {
      ...
      private var _1442907498currentColor:Ellipse;
      ...
      public function ColorDisplayGroup()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_creator_components_ColorDisplayGroupWatcherSetupUtil");
         ...
         this.width = 20;
         this.height = 20;
         this.mxmlContent = [this._ColorDisplayGroup_Ellipse1_i(),this._ColorDisplayGroup_BitmapImage1_i()];
         var i:uint = 0;
      ...
      private function _ColorDisplayGroup_Ellipse1_i() : Ellipse
      {
      ...
      [Bindable(event="propertyChange")]
      public function get currentColor() : Ellipse
      {
         return this._1442907498currentColor;
      }
      
      public function set currentColor(param1:Ellipse) : void
      {
