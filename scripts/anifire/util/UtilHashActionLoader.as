package anifire.util
{
	...
	public class UtilHashActionLoader
	{
		...
		private var data:Vector.<EventDispatcher>;

		public function UtilHashActionLoader()
		{
			super();
			this.keyToIndexMap = new UtilHashMap();
			this.indexToKeyMap = new Vector.<String>();
			this.data = new Vector.<EventDispatcher>();
		}

		public function push(param1:String, param2:EventDispatcher, param3:Boolean = true) : int
		{
			var _loc4_:int = 0;
		...
		public function insert(param1:int, param2:UtilHashActionLoader, param3:Boolean = true) : void
		{
			var _loc4_:int = 0;
		...
		public function containsValue(param1:CcActionLoader) : Boolean
		{
			var _loc2_:int = 0;
		...
		public function getValueByKey(param1:String) : EventDispatcher
		{
			var _loc2_:* = this.keyToIndexMap.getValue(param1);
			if(_loc2_ != null)
			{
		...
		public function getValueByIndex(param1:int) : EventDispatcher
		{
			return this.data[param1];
		}

		public function replaceValueByIndex(param1:int, param2:CcActionLoader) : void
		{
		...
		public function replaceValueByKey(param1:String, param2:CcActionLoader) : void
		{
		...
		public function getVector() : Vector.<EventDispatcher>
		{
			return this.data;
		}

		public function clone() : UtilHashActionLoader
		{
			var _loc1_:UtilHashActionLoader = new UtilHashActionLoader();
