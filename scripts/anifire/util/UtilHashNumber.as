package anifire.util
{
	public class UtilHashNumber
	{
		...
		public function UtilHashNumber()
		{
			super();
		...
		public function push(param1:String, param2:Number, param3:Boolean = true) : int
		{
			var _loc4_:int = 0;
		...
		public function insert(param1:int, param2:UtilHashNumber, param3:Boolean = true) : void
		{
			var _loc4_:int = 0;
		...
		public function getValueByKey(param1:String) : Number
		{
			var _loc2_:* = this.keyToIndexMap.getValue(param1);
			if(_loc2_ != null)
			{
		...
		public function getValueByIndex(param1:int) : Number
		{
			return this.data[param1];
		}

		public function replaceValueByIndex(param1:int, param2:Number) : void
		{
		...
		public function replaceValueByKey(param1:String, param2:Number) : void
		{
		...
		public function clone() : UtilHashNumber
		{
			var _loc1_:UtilHashNumber = new UtilHashNumber();
