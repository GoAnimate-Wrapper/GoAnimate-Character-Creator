package anifire.util
{
	...
	public class UtilHashBytes
	{
		...
		private var data:Vector.<ByteArray>;

		public function UtilHashBytes()
		{
			super();
			this.keyToIndexMap = new UtilHashMap();
			this.indexToKeyMap = new Vector.<String>();
			this.data = new Vector.<ByteArray>();
		}

		public function push(param1:String, param2:ByteArray, param3:Boolean = true) : int
		{
			var _loc4_:int = 0;
		...
		public function insert(param1:int, param2:UtilHashBytes, param3:Boolean = true) : void
		{
			var _loc4_:int = 0;
		...
		public function containsValue(param1:ByteArray) : Boolean
		{
			var _loc2_:int = 0;
		...
		public function getValueByKey(param1:String) : ByteArray
		{
			var _loc2_:* = this.keyToIndexMap.getValue(param1);
			if(_loc2_ != null)
			{
		...
		public function getValueByIndex(param1:int) : ByteArray
		{
			return this.data[param1];
		}

		public function replaceValueByIndex(param1:int, param2:ByteArray) : void
		{
		...
		public function replaceValueByKey(param1:String, param2:ByteArray) : void
		{
		...
		public function getVector() : Vector.<ByteArray>
		{
			return this.data;
		}

		public function clone() : UtilHashBytes
		{
			var _loc1_:UtilHashBytes = new UtilHashBytes();
