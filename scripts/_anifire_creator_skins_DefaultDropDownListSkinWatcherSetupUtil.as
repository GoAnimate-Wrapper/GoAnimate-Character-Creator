package
{
   ...
   public class _anifire_creator_skins_DefaultDropDownListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_creator_skins_DefaultDropDownListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         DefaultDropDownListSkin.watcherSetupUtil = new _anifire_creator_skins_DefaultDropDownListSkinWatcherSetupUtil();
      }
