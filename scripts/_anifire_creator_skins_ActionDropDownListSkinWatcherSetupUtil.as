package
{
   ...
   public class _anifire_creator_skins_ActionDropDownListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_creator_skins_ActionDropDownListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ActionDropDownListSkin.watcherSetupUtil = new _anifire_creator_skins_ActionDropDownListSkinWatcherSetupUtil();
      }
