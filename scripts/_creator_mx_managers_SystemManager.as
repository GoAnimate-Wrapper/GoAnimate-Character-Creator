package
{
   import anifire.creator.components.CCPreloader;
   ...
   public class _creator_mx_managers_SystemManager extends SystemManager implements IFlexModuleFactory, ISWFContext
   {
      ...
      public function _creator_mx_managers_SystemManager()
      {
         super();
      }
      ...
      override public function create(... rest) : Object
      {
         ...
         var _loc2_:String = rest.length == 0?"creator":String(rest[0]);
      ...
      override public function info() : Object
      {
         if(!this._info)
         {
            this._info = {
               ...
               "frameRate":"24",
               "height":"600",
               "mainClassName":"creator",
               "mixins":["_creator_FlexInit","_creator_Styles","mx.managers.systemClasses.ActiveWindowManager","mx.messaging.config.LoaderConfig"],
